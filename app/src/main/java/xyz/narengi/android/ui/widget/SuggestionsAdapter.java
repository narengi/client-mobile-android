...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private final CustomSearchView mSearchView;
...
/**
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        ...
        // Set up icon.
        final ImageView iconRefine = (ImageView) v.findViewById(android.support.v7.appcompat.R.id.edit_query);
...
/**
    ...
    private final static class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            ...
            mIconRefine = (ImageView) v.findViewById(android.support.v7.appcompat.R.id.edit_query);
        }
    }
    ...
    private CharSequence formatUrl(CharSequence url) {
        if (mUrlColor == null) {
            ...
            mContext.getTheme().resolveAttribute(android.support.v7.appcompat.R.attr.textColorSearchUrl, colorValue, true);
