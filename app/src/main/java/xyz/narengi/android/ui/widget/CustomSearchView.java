...
public class CustomSearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    private Runnable mShowImeRunnable = new Runnable() {
        public void run() {
            ...
            if (imm != null) {
                HIDDEN_METHOD_INVOKER.showSoftInputUnchecked(imm, CustomSearchView.this, 0);
            }
        }
    };
...
//        }
    ...
    public void setOnMenuClickListener(OnClickListener menuOnClickListener) {
        mGoButton.setOnClickListener(menuOnClickListener);
    }
...
//        updateSubmitArea();
        mSubmitArea.setVisibility(VISIBLE);
    }
...
//        if (hasFocus() && hasText) {
//            mGoButton.setImageDrawable(getContext().getResources().getDrawable(android.R.drawable.ic_lock_power_off));
//        } else {
//            mGoButton.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_action_menu));
//        }
//        mGoButton.setVisibility(visibility);
...
//        updateSubmitArea();
        mSubmitArea.setVisibility(VISIBLE);
        mGoButton.setVisibility(VISIBLE);
...
//            clearFocus();
    ...
    void onTextFocusChanged() {
        ...
        if (mSearchSrcTextView.hasFocus()) {
            forceSuggestionQuery();
            mGoButton.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_action_back));
            mCloseButton.setImageDrawable(getContext().getResources().getDrawable(android.R.drawable.ic_menu_close_clear_cancel));
        } else {
            mGoButton.setImageDrawable(getContext().getResources().getDrawable(R.drawable.ic_action_navigation_menu));
            final boolean hasText = !TextUtils.isEmpty(mSearchSrcTextView.getText());
            if (!hasText) {
...
//            mSearchSrcTextView.setDropDownWidth(getWidth());
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        void setSearchView(CustomSearchView searchView) {
